import { evalRubyFileFromExtension, evalRubyCode, evalRubyFileFromURL, printInitMessage } from "./unloosen.js";

console.log("csjs");

printInitMessage();

evalRubyCode("p Dir.glob('/unloosen/*')")

// evalRubyCode("require '/unloosen/unloosen/event/emit_content_script'")
evalRubyFileFromExtension("lib/test3.rb");
// evalRubyCode(`
// $:.unshift "/unloosen"
// p require "js"
